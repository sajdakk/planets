...
import 'package:softnauts/screens/activity/activities_details/activity_details_screen.dart';
...
class AactivitiesBodyState extends State<ActivitiesListBody> {
  late List<Activity> _availableActivities = widget.state.activitiesList;
  ...
  Widget _activitiesCardBuilder(int index, BuildContext context) {
    final Activity activities = _availableActivities[index];
