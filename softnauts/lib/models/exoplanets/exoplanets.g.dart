...
part of 'exoplanets.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

Exoplanets _$ExoplanetsFromJson(Map<String, dynamic> json) => Exoplanets(
      name: json['name'] as String,
      equatorialCoordinates: EquatorialCoordinates.fromJson(
          json['equatorial_coordinates'] as Map<String, dynamic>),
      mass: json['mass'] == null
          ? null
          : ExoplanetsData.fromJson(json['mass'] as Map<String, dynamic>),
      radius: json['radius'] == null
          ? null
          : ExoplanetsData.fromJson(json['radius'] as Map<String, dynamic>),
      inclination: json['inclination'] == null
          ? null
          : ExoplanetsData.fromJson(
...
Map<String, dynamic> _$ExoplanetsToJson(Exoplanets instance) =>
    <String, dynamic>{
      'name': instance.name,
